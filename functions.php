...
function database_run($query,$vars = array())
{
	...
	$string = "mysql:host=bjedtrauskxqfx1cxfbu-mysql.services.clever-cloud.com;dbname=bjedtrauskxqfx1cxfbu";

	$con = new PDO($string,'ueq3l2hgcwqhxmrm','VbDPYcGifErUzG4rtYf8');
